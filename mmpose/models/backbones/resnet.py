...
class BasicBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv2 = build_conv_layer(
            ...
            padding=1,
            bias=False)
        # self.depthconv2 = build_conv_layer(
        #     conv_cfg,
        #     self.mid_channels,
        #     self.mid_channels,
        #     3,
        ...
        #     bias=False)
        # self.pointconv2 = build_conv_layer(
        #     conv_cfg,
        #     self.mid_channels,
        #     out_channels,
        #     1,
    ...
    def _make_stem_layer(self, in_channels, stem_channels):
        ...
        if self.deep_stem:
            ...
            self.conv1 = build_conv_layer(
                ...
                padding=3,
                bias=False)
            # self.depthconv1 = build_conv_layer(
            #     self.conv_cfg,
            #     in_channels,
            #     in_channels,
            #     kernel_size=7,
            ...
            #     groups=in_channels,
            #     bias=False)
            # self.pointconv1 = build_conv_layer(
            #     self.conv_cfg,
            #     in_channels,
            #     stem_channels,
            #     kernel_size=1,
        ...
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)#3,2,1
